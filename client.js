...
socket.on('connect', function(){
    ...
    //             rows:[
    //                 {"objid":"EQP01", "DQ":2, "PROC":3, "WQ": 4},
    //                 {"objid":"EQP02", "DQ":1, "PROC":0, "WQ": 2},
    //                 {"objid":"EQP03", "DQ":0, "PROC":1, "WQ": 4}
    //             ]
    //         },
    //         {
    //             "updatedat":"2019-09-10 14:00:00", 
    //             rows:[
    //                 {"objid":"EQP01", "DQ":7, "PROC":3, "WQ": 1},
    //                 {"objid":"EQP02", "DQ":1, "PROC":2, "WQ": 3},
    //                 {"objid":"EQP03", "DQ":3, "PROC":0, "WQ": 4}
    //             ]
    //         }
    //     ]
    // });
    ...
    socket.emit('GetSnapshotwip', {resultid: 319, snapshotid: 0});
    //socket.emit('StopMonitoringData');

});
socket.on('event', function(data){});
socket.on('disconnect', function(){});
socket.on("ResultGetSnapshotwip", function (data) {
    console.log(util.inspect(data, {showHidden: false, depth: null}));
});
socket.on("ResultGetClass", function (data) {
    console.log(util.inspect(data, {showHidden: false, depth: null}));
});
